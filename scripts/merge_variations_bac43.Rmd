...
```{r annotated snps}
snps <- read.csv("20230503_within-host/17_snpeff/bac43/summary/bac43_annotated_summary.csv", sep=';', header=T,row.names=NULL) 
...
data <- read.csv("20230503_within-host/15_bac43_variation/summary/bac43_variation_summary.csv",sep='\t')
...
p<- data %>% filter(pairid==67|pairid==59) %>%  remove_empty(which = "cols")
...
clusterA<- data %>% filter(pairid==14|pairid==106|pairid==55|pairid==11|pairid==68|pairid==107|pairid==57|pairid==15|pairid==6|pairid==48|pairid==70|pairid==49|pairid==71|pairid==18|pairid==33|pairid==20|pairid==101) %>%  remove_empty(which = "cols")
